package m.a.nobahar.android.ui.widget.components
...
import m.a.nobahar.android.ui.widget.WidgetPoemTheme
    ...
    Column(
        ...
        Box(
            modifier = GlanceModifier
                .cornerRadius(26.dp)
                .background(PoemTheme.colorScheme.errorContainer)
        ) {
            Image(
                ...
                modifier = GlanceModifier
                    .size(56.dp)
                    .padding(8.dp),
                colorFilter = ColorFilter.tint(ColorProvider(PoemTheme.colorScheme.error))
            )
        }
        ...
        GlanceText(
            ...
            modifier = GlanceModifier
                ...
                .background(PoemTheme.colorScheme.primary),
            color = Color.White
        )
    }
}
